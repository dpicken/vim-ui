...
call s:NoRemapNVOI("<silent> <F6>", "", "", "", "", ":<Esc>:make<CR>")
...
call s:NoRemapNVOI("<silent> <S-F8>", "", "<Esc>", "<Esc>", "<Esc>", ":call ToggleLocalOption(\"paste\")<CR>")
call s:NoRemapNVOI("<silent> <F9>", "", "<Esc>", "<Esc>", "<C-O>", ":call InsertBoilerPlate()<CR>")
